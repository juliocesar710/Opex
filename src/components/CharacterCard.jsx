  ...
  return (
    <Link to={`/character/${id}`} className="group">
      ...
      <div className="bg-[#fdf3d8] text-[#3e2c1c] border-[6px] border-[#af895c] rounded-xl shadow-lg hover:scale-105 transition-transform duration-300 font-wanted cursor-pointer
        h-[500px] flex flex-col relative overflow-hidden transform group-hover:rotate-1 group-hover:shadow-xl "
      >
        {/* Efeito de papel envelhecido */}
        
        {/* Cabeçalho - altura fixa */}
        <div className="bg-[#a12c2f] px-4 py-2 text-center text-3xl font-extrabold tracking-widest border-b-[6px] border-[#af895c] text-[#f3e5ab] relative overflow-hidden h-[60px] flex items-center justify-center">
        ...
        {/* Texto DEAD OR ALIVE - altura fixa */}
        <div className="text-center py-1 bg-[#e6d1a9] border-b-[6px] border-[#af895c] h-[40px] flex items-center justify-center">
          <p className="text-xl font-bold italic text-[#a12c2f]">DEAD OR ALIVE?</p>
        </div>

        {/* Container da imagem com altura proporcional */}
        {imageUrl && (
          <div className="relative overflow-hidden border-b-[6px] border-[#af895c] flex-1 max-h-[240px] min-h-[200px]">
            <img
              src={imageUrl}
              alt={name}
        ...
        {/* Área de informações - altura flexível mas com mínimo */}
        <div className="p-4 flex flex-col justify-between flex-1 min-h-[160px] relative z-10 overflow-y-auto">
            ...
            <div className="flex justify-center items-center my-2">
              ...
              <div className="mx-2 border-t-2 border-b-2 border-[#af895c] py-2 px-4">
                <p className="text-lg font-semibold text-[#6b3e26] mb-1">
                  ...
                  <span className="text-1xl text-[#a12c2f] font-wanted">฿ {bounty.toLocaleString("en-US")}</span>
                </p>
              </div>
              <span className="text-4xl text-[#af895c] font-wanted">{'}'}</span>
            </div>
        ...
        {/* Selo dos Marines */}
        <div className="absolute bottom-2 opacity-25 right-2 w-12 h-12 bg-[#a12c2f] rounded-full flex items-center justify-center text-white text-xs font-bold border-2 border-white">
          MARINE
        </div>
